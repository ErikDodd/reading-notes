...
It is more helpful because it allows you to set different sizes for different media containers. This different sizes make it more easier to make your images responsive than if you were just using an src attribute.
